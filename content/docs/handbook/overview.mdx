...
This handbook provides an overview of the different parts that make up a WAVS application.
...
- [How it works](../how-it-works) - Learn about the different parts that make up a WAVS service.
- [Design](../design) - Learn about the design considerations for building a WAVS service.
